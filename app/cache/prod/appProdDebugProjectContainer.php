...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod/annotations', true);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_835e3c546d59c505fb34c6da2698675a620d1d2faeb8cd8c162998e7bf5fd82e');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_835e3c546d59c505fb34c6da2698675a620d1d2faeb8cd8c162998e7bf5fd82e');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_835e3c546d59c505fb34c6da2698675a620d1d2faeb8cd8c162998e7bf5fd82e');
        ...
        $d->setProxyDir('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/../web', true);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod',
            ...
            'debug.container.dump' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod/sessions',
            ...
            'router.resource' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/prod/doctrine/orm/Proxies',
