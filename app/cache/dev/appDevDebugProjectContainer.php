...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_1' => 'get0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca1Service',
            '0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_2' => 'get0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca2Service',
            '0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_3' => 'get0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca3Service',
            '087e3df1f9a9d84da441bd928f172dfa5ba0ee2fcc143870a62c3ab91d85cdf4_1' => 'get087e3df1f9a9d84da441bd928f172dfa5ba0ee2fcc143870a62c3ab91d85cdf41Service',
    ...
    /**
     * Gets the '0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_1' service.
     *
     ...
     */
    protected function get0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca1Service()
    {
        return $this->services['0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca2Service()
    {
        return $this->services['0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca3Service()
    {
        return $this->services['0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }

    /**
     * Gets the '087e3df1f9a9d84da441bd928f172dfa5ba0ee2fcc143870a62c3ab91d85cdf4_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get087e3df1f9a9d84da441bd928f172dfa5ba0ee2fcc143870a62c3ab91d85cdf41Service()
    {
        return $this->services['087e3df1f9a9d84da441bd928f172dfa5ba0ee2fcc143870a62c3ab91d85cdf4_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3306', 'dbname' => 'symfony', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_989a70ea9176ad2d018a755f1352ffa4a3e34dbc0d65f6ce4ed249b076517f76');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_989a70ea9176ad2d018a755f1352ffa4a3e34dbc0d65f6ce4ed249b076517f76');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_989a70ea9176ad2d018a755f1352ffa4a3e34dbc0d65f6ce4ed249b076517f76');
        ...
        $d->setProxyDir('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('087e3df1f9a9d84da441bd928f172dfa5ba0ee2fcc143870a62c3ab91d85cdf4_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Users/hsng/Documents/sites/php-symfony2-myProject1/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_1'), 1 => $this->get('0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_2'), 2 => $this->get('0629c0089d6b1e59923393dba2b7db8ba11c9f3103865098c9a0bd39342874ca_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/hsng/Documents/sites/php-symfony2-myProject1/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Users/hsng/Documents/sites/php-symfony2-myProject1/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/hsng/Documents/sites/php-symfony2-myProject1/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Users/hsng/Documents/sites/php-symfony2-myProject1/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        ...
        $instance->addPath('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/Resources/views');
        $instance->addPath('/Users/hsng/Documents/sites/php-symfony2-myProject1/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e20029738ae276843c1f79ab3cbef0d96fef7d89');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Users/hsng/Documents/sites/php-symfony2-myProject1/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev',
            'kernel.logs_dir' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/logs',
            ...
            'locale' => 'en',
            'secret' => 'e20029738ae276843c1f79ab3cbef0d96fef7d89',
            'debug_toolbar' => true,
            ...
            'debug.container.dump' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => 'e20029738ae276843c1f79ab3cbef0d96fef7d89',
            ...
            'session.save_path' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/profiler',
            ...
            'router.resource' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/../web',
            'assetic.write_to' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Users/hsng/Documents/sites/php-symfony2-myProject1/app/cache/dev/doctrine/orm/Proxies',
